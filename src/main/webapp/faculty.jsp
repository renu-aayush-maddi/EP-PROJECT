...
<html>
<head>
    <title>College Timetable Generator - Faculty Portal</title>
    <style>
...
<body>
    <div class="header">
        <h1>Welcome to the Faculty Portal, ${sessionScope.username}!</h1>
    ...
    <div class="content">
        ...
        <div class="card">
            <h2>View Courses</h2>
            <p>View the list of courses you teach.</p>
            <a href="viewCourses.jsp">View Courses</a>
        </div>
        <div class="card">
            <h2>View Student Details</h2>
            <p>View the details of your students.</p>
